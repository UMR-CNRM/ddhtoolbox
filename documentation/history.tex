...
\begin{description}
  ...
  \item [2026:] Flexible DDH : ARPEGE and AROME dynamical budgets have been updated, to better diagnose semi-lagrangian advection terms. The budget becomes more accurate, resulting in smaller residuals --developed on cycle cy49t1.op1.06-- (Fabrice Voitus).
  \item [2026:] Flexible DDH : ARPEGE budget documented in a dedicated section: list of items involved, graphical summary of the water balance --vapour, liquid, ice, rain, snow-- (Meryl Wimmer).
\end{description}
