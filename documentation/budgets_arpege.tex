\chapter{Budget and diagnostics, \arp\ model, original dataflow}
\null
\vspace{1cm}
This chapter presents budget equations which are the first application of DDH. It gives information about the content of output files. Original dataflow corresponds to the first dataflow implementation developed in the system, prior to the introduction of the flexible DDH, presented in chapter \ref{chap_flexible_arpege} and section \ref{sec_new_dataflow}.
...
\chapter{Budget and diagnostics, \arp\ model, flexible dataflow}
\label{chap_flexible_arpege}
\null
\vspace{1cm}
