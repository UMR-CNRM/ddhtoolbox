...
do jy=1,ky
  do jx=1,kx
    ...
    !
    !-------------------------------------------------
    ! Définition du pavé en SVG.
    !-------------------------------------------------
    !
    write(clrect,fmt='(4(a,f8.2),3(a,i3.3),100a)') '<rect x="',zxcoin,'" y="',zycoin,'" width="',zwidth_rect &
    &,'" height="',zheight_rect,'" style="fill:rgb(',irvb(1),',',irvb(2),',',irvb(3) &
    &,')" />'
