...
do jim=2,23
  ix=1+modulo(jim-1,6)
  iy=(jim-1)/6+1
  ixpos=131/2 + (ix-1)*131
  iypos=89+(iy-1)*(163-89)
  !write(*,*) 'ncoul(jpal)=ncoul(jpal)+1 ; rvbpal(1,ncoul(jpal),jpal)=',krvb1(1,ixpos,iypos),' ; rvbpal(2,ncoul(jpal),jpal)=',krvb1(2,ixpos,iypos),' ; rvbpal(3,ncoul(jpal),jpal)=',krvb1(3,ixpos,iypos)
  ih=jim+10
  write(*,'(a,i2.2,3x,3(i3.3,1x))') '#PAL_SPECIF= < ',ih,krvb1(1,ixpos,iypos),krvb1(2,ixpos,iypos),krvb1(3,ixpos,iypos)
enddo
do jy=1,kny1
  do jx=1,knx1
