...
write(iul,fmt='(9a)') 'if test ',cdf1(1:len_trim(cdf1)),' -ot ',cdf2(1:len_trim(cdf2))
write(iul,fmt='(9a)') 'then'
write(iul,fmt='(9a)') '	echo "oui"'
write(iul,fmt='(9a)') 'else'
write(iul,fmt='(9a)') '	echo "non"'
write(iul,fmt='(9a)') 'fi'
close(iul)
!
!-------------------------------------------------
